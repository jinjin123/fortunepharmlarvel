...
""),10)-parseInt(d.date.replace(/[^0-9]/g,""),10)});return b};this._createElement=function(b,c){b=e.extend({},a._default_element_data,b);var d=e("<div>").addClass("timeline_element "+b.type);"left"===c?d.addClass("timeline_element_left"):"right"===c&&d.addClass("timeline_element_right");a._options.animation||d.addClass("animated");var g=e("<div>").addClass("timeline_element_box").appendTo(d);b.title?e("<div>").addClass("timeline_title").html('<span class="timeline_title_label">'+b.title+'</span><span class="timeline_title_date">'+
a._getDateString(b.date,b.dateFormat||a._options.dateFormat)+"</span>").appendTo(g):d.addClass("notitle");switch(b.type){case "iframe":g=e("<div>").addClass("content loading").height(b.height).appendTo(g);a._iframe_queue.push({element:g,url:b.url});break;case "gallery":if(b.images.length){b.content&&e("<div>").addClass("content").html(b.content).appendTo(g);var h="";e(b.images).each(function(c,d){h+='<div class="img_container"><img style="height:'+b.height+'px;" src="'+d+'" />';a._options.lightbox&&
(h+='<div class="img_overlay"><span class="magnifier" data-total="'+b.images.length+'" data-order="'+c+'" data-img="'+d+'"></span></div>');h+="</div>"});e("<div>").addClass("scroll_container").appendTo(g).html(h)}break;case "blog_post":b.content||b.readmore||d.addClass("nocontent");var f="";e(b.images).each(function(c,d){f+='<div data-total="'+b.images.length+'" data-order="'+c+'" class="img_container'+(0===c?" active":"")+'" style="display:'+(0===c?"block":"none")+';"><img src="'+d+'" />';a._options.lightbox&&
(f+='<div class="img_overlay"><span class="magnifier" data-total="'+b.images.length+'" data-order="'+c+'" data-img="'+d+'"></span></div>');f+="</div>"});1<b.images.length&&(f+='<span class="slider_prev"></span><span class="slider_next"></span>');e("<div>").addClass("slider_container").html(f).appendTo(g);b.content&&e("<div>").addClass("content").html(b.content).appendTo(g);b.readmore&&e("<div>").addClass("readmore").html('<a href="'+b.readmore+'">'+a._readmore_text+"</a>").appendTo(g);1<b.images.length&&
b.speed&&(d.data("speed",b.speed),setTimeout(function(){a._updateSlider(d,"next")},b.speed))}d.appendTo(a._container);a._elements.push(d);return d};this._createSeparator=function(b){b=e("<div>").addClass("date_separator").attr("id","timeline_date_separator_"+b).html("<span>"+b+"</span>").appendTo(a._container);a._options.animation||b.addClass("animated");a._separators.push(b)};this._render=function(b,c){var d=!0;e(b).each(function(b,h){if(a._options.max&&a._options.max<=b&&!c)return!1;if(c&&0===b){var f=
a._container.children(":last");f.length&&f.hasClass("timeline_element_left")&&(d=!1)}var f=parseInt(h.date.split("-")[0],10),l=parseInt(h.date.split("-")[1],10),l=f+"-"+l,k=!1;-1!==e.inArray(f,a._years)||"year"!==a._options.separator&&null!==a._options.separator||(k=!0,a._years.push(f));-1!==e.inArray(l,a._months)||"month"!==a._options.separator&&"month_year"!==a._options.separator||(k=!0,a._months.push(l));if(k){if("year"===a._options.separator)(1<a._years.length||a._options.first_separator)&&a._createSeparator(f);
...
b.find(".img_container.active").removeClass("active"),g="next"===c?d.data("order")===d.data("total")-1?b.find(".img_container:first").addClass("active"):d.next().addClass("active"):0===d.data("order")?b.find(".img_container:last").addClass("active"):d.prev().addClass("active");g.css({position:"absolute",top:0,left:0,"z-index":10}).fadeIn(300,function(){g.css({position:"",top:"",left:"","z-index":""});d.hide()})}if(b.data("speed")){var e=setTimeout(function(){a._updateSlider(b,c)},b.data("speed"));
...
a._overlay.addClass("open");e("<img>").attr("src",c).appendTo(a._lightbox);var d=a._getLightboxSize(g.width,g.height);a._lightbox.addClass("loaded").css({width:d.width,height:d.height})},g=new Image;g.onload=d;g.onerror=d;g.src=c},1E3),c};this._closeLightBox=function(){a._transitionEnd(a._lightbox,function(){a._overlay.removeClass("open");a._lightbox.removeAttr("style").children("img").remove()});a._lightbox.removeClass("loaded")};this._getLightboxSize=function(a,c){var d=e(window).width()-60,g=e(window).height()-
60,h=a,f=c;if(a>d||c>g)a>d&&c<=g?(h=d,f=c/(a/h)):c>g&&a<=d?(f=g,h=a/(c/f)):(h=d,f=c/(a/h),f>g&&(f=g,h=a/(c/f)));return{width:h,height:f}};this._navLightBox=function(b,c){var d=a._lightbox.data("magnifier");if("next"===c){var e=d.parents(".img_container:first").next(".img_container");e.length||(e=d.parents(".img_container:first").parent().children(".img_container:first"))}else e=d.parents(".img_container:first").prev(".img_container"),e.length||(e=d.parents(".img_container:first").parent().children(".img_container:last"));
var h=e.find("span.magnifier"),f=h.data("img"),l=new Image;l.onload=function(){a._lightbox.data("magnifier",h).addClass("updating");a._lightbox.children("img").attr("src",f);var b=a._getLightboxSize(l.width,l.height);a._lightbox.css({width:b.width,height:b.height});setTimeout(function(){a._lightbox.removeClass("updating")},500)};l.src=f};this._processIframeQueue=function(){e(a._iframe_queue).each(function(a,c){c.element.removeClass("loading").html('<iframe frameborder="0" src="'+c.url+'"></iframe>')})};
...
!1}};this._loadFacebook=function(b){var c="/"+a._options.facebookPageId+"/feed",d={access_token:a._options.facebookAccessToken},g=[],h=0,f=function(){a._original_data=g;b!==n&&b();if(a._options.onSearchSuccess)a._options.onSearchSuccess(g)},l=function(b){var c='<div class="facebook_type_'+b.type+'"><div class="facebook_left_column"><img class="facebook_profile" src="https://graph.facebook.com/'+b.from.id+'/picture?type=square" /></div><div class="facebook_right_column">';b.message&&(c+='<div class="facebook_content">'+
b.message.trimString(a._facebook_message_length).parseURL()+"</div>");return c+'</div><div style="clear:both;"></div>'},k=function(a,b){g.push({type:"blog_post",date:a.updated_time,title:a.from.name,content:b})};FB.init({appId:a._options.facebookAppId,version:"v2.0"});FB.api(c,d,function(b){if(b&&b.data&&b.data.length)e(b.data).each(function(b,c){if(c.from.id)if("photo"===c.type)h++,FB.api("/"+c.object_id,d,function(a){var b=l(c);a.source&&(b+='<div class="facebook_post"><a href="'+c.link+'" style="display:inline;"><img class="facebook_picture" align="left" src="'+
a.source+'" /></a></div>');k(c,b+"</div>");h--;0===h&&f()});else if(c.message){var e=l(c);c.picture&&(e+='<div class="facebook_post"><a href="'+c.link+'" style="display:inline;"><img class="facebook_picture" align="left" src="'+c.picture+'" /></a><div class="description_container">'+(c.name?'<a href="'+c.link+'">'+c.name+"</a>":"")+(c.caption?'<div class="facebook_caption">'+c.caption+"</div>":"")+(c.description?'<div class="facebook_description">'+c.description.trimString(a._facebook_description_length).parseURL()+
"</div>":"")+"</div></div>");k(c,e+"</div>")}}),0===h&&f();else if(a._options.onSearchError)a._options.onSearchError(b)})};this._loadTwitter=function(b){e.getJSON("//www.melonhtml5.com/api/?action=twittersearch&q="+a._options.twitterSearchKey+"&callback=?",function(c){var d=[];if(c.statuses.length){if(e(c.statuses).each(function(a,b){d.push({type:"blog_post",date:b.created_at,title:'<a href="http://www.twitter.com/'+b.user.screen_name+'" target="_blank" style="text-decoration:none;color:#AAAAAA;">'+
b.user.screen_name+"</a>",content:'<div><img class="twitter_profile" align="left" src="'+b.user.profile_image_url+'" /></div>'+b.text.parseURL().parseHashtag()})}),a._original_data=d,b!==n&&b(),a._options.onSearchSuccess)a._options.onSearchSuccess(c)}else if(a._options.onSearchError)a._options.onSearchError(c)})};this.setOptions=function(b){a._options=e.extend(a._options,b);return a._options};this.display=function(){var b=function(){a._prepareData();a._display()};a._original_data&&a._original_data.length?
b():a._options.twitterSearchKey?a._loadTwitter(b):a._options.facebookAppId&&a._options.facebookAccessToken&&a._options.facebookPageId&&FB&&a._loadFacebook(b)};this.appendData=function(b){var c=parseInt(a._data[a._data.length-1].date.replace(/-/g,""),10),d=[];"desc"===a._options.order?e(b).each(function(a,b){parseInt(b.date.replace(/-/g,""),10)<=c&&d.push(b)}):e(b).each(function(a,b){parseInt(b.date.replace(/-/g,""),10)>=c&&d.push(b)});a._data=a._data.concat(d);a._render(d,!0);a._options.animation?
a._startAnimation(a._processIframeQueue):a._processIframeQueue()}};