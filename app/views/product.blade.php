...
$page="product";
$img_lang="img_".$lang;
$store_description="store_description_".$lang;
$store_linkage="store_linkage_".$lang;
if($lang === 'eng') $market_desc_lang = 'For more details, please visit : https://fortune.tmall.com';
if($lang === 'cht') $market_desc_lang = '產品詳情 請瀏覽 國內天貓幸福母嬰旗艦店 : https://fortune.tmall.com';
if($lang === 'chs') $market_desc_lang = '产品详情 请浏览 国内天猫幸福母婴旗舰店 : https://fortune.tmall.com';
...
if (!isset($products)){
$products=DB::table('products')->where('markets_id', 1)->where('series_id', 1)->get();
}
...
<?php if(($products[$product_tab]->main_series === 'Children Series') || $current_serie[0]->main_series === 'Children Series'): ?>
			...
			<div id="main">
				<div class="container-fluid">
					<section id="banner-wrapper">
						<?php if($lang=='eng' && ($current_serie[0]->main_series === 'Normal Series' && !$products[$product_tab]->main_series)):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_en.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_mobile_en.jpg" class="visible-xs">
						<?php elseif($lang=='eng' && ($current_serie[0]->main_series === 'Children Series' && !$products[$product_tab]->main_series)):?>
						...
						<?php elseif($lang=='eng' && $products[$product_tab]->main_series === 'Children Series'):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/child_banner_en.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/child_banner_mobile_en.jpg" class="visible-xs">	
						<?php elseif($lang=='eng' && $products[$product_tab]->main_series === 'Normal Series'):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_en.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_mobile_en.jpg" class="visible-xs">
						
						<?php elseif($lang=='cht' && ($current_serie[0]->main_series === 'Normal Series' && !$products[$product_tab]->main_series)):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_mobile.jpg" class="visible-xs">
						<?php elseif($lang=='cht' && ($current_serie[0]->main_series === 'Children Series' && !$products[$product_tab]->main_series)):?>
						...
						<?php elseif($lang=='cht' && $products[$product_tab]->main_series === 'Children Series'):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/child_banner.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/child_banner_mobile.jpg" class="visible-xs">	
						<?php elseif($lang=='cht' && $products[$product_tab]->main_series === 'Normal Series'):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_mobile.jpg" class="visible-xs">
						
						<?php elseif($lang=='chs' && ($current_serie[0]->main_series === 'Normal Series' && !$products[$product_tab]->main_series)):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_sc.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_mobile_sc.jpg" class="visible-xs">
						<?php elseif($lang=='chs' && ($current_serie[0]->main_series === 'Children Series' && !$products[$product_tab]->main_series)):?>
						...
						<?php elseif($lang=='chs' && $products[$product_tab]->main_series === 'Children Series'):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/child_banner_sc.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/child_banner_mobile_sc.jpg" class="visible-xs">	
						<?php elseif($lang=='chs' && $products[$product_tab]->main_series === 'Normal Series'):?>
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_sc.jpg" class="hidden-xs">
						<img src="{{$GLOBALS['home_directory']}}assets/img/top_banner/product_banner_mobile_sc.jpg" class="visible-xs">
						<?php endif;?>	
					</section>
					<section id="product-tab">
						<ul class="market-tab-wrapper nav navbar-nav">
							<li class=<?=$market_tab=='hongkong'?"active":""?>><a href="{{$GLOBALS['home_directory']}}{{$lang}}/product/hongkong/1/0">{{$marketname[0]}}</a></li>
							<li class=<?=$market_tab=='china'?"active":""?>><a href="{{$GLOBALS['home_directory']}}{{$lang}}/product/china/12/0">{{$marketname[1]}}</a></li>
							<li class=<?=$market_tab=='oversea'?"active":""?>><a href="{{$GLOBALS['home_directory']}}{{$lang}}/product/oversea/10/0">{{$marketname[2]}}</a></li>
						</ul>
						...
						<div class="sub-tab-session">
							<div class="sub-tab-outer-wrapper scroll-wrapper">
								<ul class="sub-tab-wrapper nav navbar-nav">
									...
									<li class=<?=$series_main_series[$x]==='Normal Series'?"normal":"children"?><?=$series_tab==$sid?"_active":""?>><a href="{{$GLOBALS['home_directory']}}{{$lang}}/product/{{$market_tab}}/{{$sid}}/0">{{$series_data_name[$x]}} </a></li>
									<?php $x++;?>
									<?php endforeach;?>
						...
						<div class="tab-icon-outer-wrapper scroll-wrapper">
							<ul class="tab-icon-wrapper nav navbar-nav">
								...
								<li><a href="{{$GLOBALS['home_directory']}}{{$lang}}/product/{{$market_tab}}/{{$series_tab}}/{{$x}}"><img src="{{$GLOBALS['home_directory']}}app/storage/uploads/thumbs/medium/{{$product->product_img1}}"></a></li>
								<?php $x++;?>
								<?php endforeach;?>
							</ul>
						</div>
					...
					<section id="product-wrapper" class="row">
						<div class="col-xs-10 col-sm-6 product-big-image">
							...
							<img src="{{$GLOBALS['home_directory']}}app/storage/uploads/thumbs/medium/{{$products[$product_tab]->product_img1}}"/>
					...
					<?php if($products[$product_tab]->$store_description): ?>
					<div style="background-color: #F7F7F7;width: 470px;height: 50px;padding: 15px">
						<?php if($products[$product_tab]->$store_linkage): ?> 
							<a href="{{$products[$product_tab]->$store_linkage}}" target="_blank">
						<?php endif ?>
						<p class="grey"><?php echo $products[$product_tab]->$store_description ?></p>
						<?php if($products[$product_tab]->$store_linkage): ?> 
						</a>
						<?php endif ?>
					</div>
