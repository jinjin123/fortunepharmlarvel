...
<body id="health-tips" class="bloating">
	<div id="wrapper">
					...
					<section id="tips-wrapper">
						...
						<div class="content-outer-wrapper">
							<div class="notice-wrapper">
								<p>{{$healthtipsevens[0]->$lang_intro1}}</p>
							</div>
							<div class="function-wrapper">
								<div class="function-full-wrapper col-sm-12">
									<img src="{{$GLOBALS['home_directory']}}assets/img/tips/trip_9_bg.png">
								</div>
							</div>
							<div class="detail-wrapper detail-wrapper2">
								...
								{{$healthtipsevens[0]->$lang_detail1}}
								</div>
							</div>
						</div>
					</section>
